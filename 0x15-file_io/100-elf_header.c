...
/**
 * check_elf - Checks a file if is an ELF file.
...
/**
 * print_class - function that print the class of an ELF header.
...
/**
 * print_data - Print a data of an ELF header.
 * @e_ident: pointer to an array containing the ELF class.
 */
...
int main(int __attribute__((__unused__)) argc, char *argv[])
{
	...
	rite = read(o, header, sizeof(Elf64_Ehdr));
	if (rite == -1)
	{
		free(header);
		close_elf(o);
